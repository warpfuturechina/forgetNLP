...
public class WordDictBLL {
    ...
    public static void UpdateKeyWordColl(String text, MemoryBondColl objCharBondColl, MemoryItemColl objKeyWordColl, boolean bUpdateCharBondColl, boolean bUpdateKeyWordColl){
    ...
    public static void UpdateCharBondColl(String text, MemoryBondColl objCharBondColl){
        if (text ==null || text.isEmpty()) {
            return;
        }
        String keyHead = String.valueOf(text.charAt(0));
